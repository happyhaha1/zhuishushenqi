...
class QSSearchViewController: BaseViewController{
    ...
    lazy var tableView:UITableView = {
        let tableView = UITableView(frame: CGRect(x: 0, y: 300, width: ScreenWidth, height: ScreenHeight - 300), style: .grouped)
    ...
    func initSubview(){
        ...
        bgView.frame = CGRect(x: 0, y: kNavibarH, width: self.view.bounds.width, height: 44)
