...
/// 导航栏高度
let NavgationBarHeight:CGFloat = kNavibarH

/// TabBar高度
let TabBarHeight:CGFloat = kTabbarH

/// StatusBar高度
let StatusBarHeight:CGFloat = kStatusbarH
...
/// 小说阅读颜色
let DZMColor_5:UIColor = RGB(0, g: 0, b: 0)
