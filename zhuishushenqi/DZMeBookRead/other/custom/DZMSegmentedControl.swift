...
class DZMSegmentedControl: UIView {
    ...
    //显示位置
    var titleAlignment = [UIControlContentHorizontalAlignment]()
    ...
    private func addSubviews() {
        ...
        for i in 0..<count {
            ...
            if !titleAlignment.isEmpty {
                button.contentHorizontalAlignment = titleAlignment[i]
            }
            
            if !contentEdgeInsets.isEmpty {
                button.contentEdgeInsets = contentEdgeInsets[i]
            }
