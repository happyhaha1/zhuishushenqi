...
class DZMRMLeftView: DZMRMBaseView,DZMSegmentedControlDelegate,UITableViewDelegate,UITableViewDataSource {
    ...
    override func addSubviews() {
        ...
        topView.titleAlignment = [UIControlContentHorizontalAlignment.left,UIControlContentHorizontalAlignment.right]
        topView.contentEdgeInsets = [UIEdgeInsetsMake(0, 30, 0, 0),UIEdgeInsetsMake(0, 0, 0, 30)]
        ...
        let swipeGesture = UISwipeGestureRecognizer(target: self, action: #selector(DZMRMLeftView.handleSwipeGesture(sender:)))
    ...
    override func layoutSubviews() {
        ...
        // contentView
        let contentViewW:CGFloat = width
